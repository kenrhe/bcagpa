...
<html lang="en">
    ...
    <body>
        ...
        ${error}
	<div style="" class="alert"><b>Woops!</b> The PowerSchool Parent Portal is closed at the moment, which means that this app will not work. Enjoy the summer and check back late August!</div>
